    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now=True)),
                ('book_author', models.ForeignKey(help_text='Book Author', null=True, on_delete=django.db.models.deletion.SET_NULL, to='home1.Author')),
                ('genre', models.ManyToManyField(help_text='genre of the book', to='home1.Genre')),
            ],
        ),
    ]
